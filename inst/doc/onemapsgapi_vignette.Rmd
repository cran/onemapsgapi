...
## Planning Areas
These functions are a wrapper for the [Planning Area API](https://docs.onemap.sg/#planning-area). Planning Area API endpoints allow users to get spatial data and data related to the planning areas in Singapore. This package provides users with the ability to query the data and optionally handles necessary spatial data wrangling on behalf of the user.
